...
subtitle: 비슷한 유형 - BOJ - 2357 최솟값과 최댓값
...
![Segment Tree Image]({{ site.baseurl }}/assets/img/segmentTree/세그먼트트리.png)
...
![Tree Image]({{ site.baseurl }}/assets/img/segmentTree/seg-tree.png)  
<br><br>
...
![Tree Sum Image]({{ site.baseurl }}/assets/img/segmentTree/seg-sum-tree.png)

<br><br>
트리의 노드 번호를 그림으로 표현하면 다음과 같다.
<br><br>
![Tree Index Image]({{ site.baseurl }}/assets/img/segmentTree/seg-index-tree.png)
<br><br>
...
![Tree Index Image]({{ site.baseurl }}/assets/img/segmentTree/seg-tree-qeury.png)
...
![Tree Index Image]({{ site.baseurl }}/assets/img/segmentTree/seg-tree-update-1.png)
<br><br>
...
![Tree Index Image]({{ site.baseurl }}/assets/img/segmentTree/seg-tree-update-2.png)
<br><br>
