...
![Segment Tree Image]({{ site.baseurl }}/assets/img/세그먼트트리.png)
...
### 따라서 총 node의 합은 $$2^{┌log_2 N┐+1} - 1$$ 이 된다. 즉, 배열의 크기를 $$2^{┌log_2 N┐+1} - 1$$ 로 설정하면 된다.
...
![Tree Image]({{ site.baseurl }}/assets/img/seg-tree.png)  
<br><br>
...
![Tree Sum Image]({{ site.baseurl }}/assets/img/seg-sum-tree.png)

<br><br>
트리의 노드 번호를 그림으로 표현하면 다음과 같다.
<br><br>
![Tree Index Image]({{ site.baseurl }}/assets/img/seg-index-tree.png)
<br><br>
...
![Tree Index Image]({{ site.baseurl }}/assets/img/seg-tree-qeury.png)
...
![Tree Index Image]({{ site.baseurl }}/assets/img/seg-tree-update-1.png)
<br><br>
...
![Tree Index Image]({{ site.baseurl }}/assets/img/seg-tree-update-2.png)
<br><br>
