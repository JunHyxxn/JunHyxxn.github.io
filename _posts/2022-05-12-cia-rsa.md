...
![Configentiality]({{site.baseurl}}/assets/img/jwt/confidentiality.png)
...
![Integrity & Available]({{site.baseurl}}/assets/img/jwt/integrity-available.png)
<br><br>
C가 가로채 위조 데이터를 전송하게 되면 데이터의 무결성이 꺠지고, B는 제대로 된 데이터를 받지 못해 가용성이 깨진다.

<br><br>

## CIA을 보장하기 위해 문서를 암호화, 보안을 적용해 전송할 필요가 있다.
...
### 즉, 열쇠 전달의 문제 & 누구로부터 받은 데이터인지 알 수 있다면 CIA를 만족할 수 있다.
...
<br>
앞서 보안 3요소 CIA를 만족하기 위해서는 두 가지 문제점을 해결하면 된다고 알아봤다.  
1️⃣ : 열쇠 전달의 문제  
2️⃣ : 누구로부터 받은 데이터인지 확인
<br>
RSA는 2가지 키를 갖는다.
...
<br>
![암호화]({{site.baseurl}}/assets/img/jwt/encryption.png)
<br><br>

### Signature - 서명

<br>
![서명]({{site.baseurl}}/assets/img/jwt/signature.png)
<br><br>
