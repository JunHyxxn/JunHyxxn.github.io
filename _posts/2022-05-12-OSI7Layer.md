...
layout: post
title: OSI 7계층
subtitle: 통신 - Open Systems Interconnection 7 Layer
tags: [Network, OSI 7계층, 통신, TIL]
author: JunHyxxn
use_math: true
comments: true
---
...
![OSI 7 Layer]({{ site.baseurl }}/assets/img/network/OSI7LayerImg.png)
<br><br>
...
데이터를 암호화, 압축, 부호화, 인코딩 등의 동작이 해당 계층에서 이루어진다.
...
통신을 활성화하기 위한 계층이다.  
TCP/UDP 프로토콜을 이용해 응용 프로그램들이 전송을 할 수 있도록 한다.  
데이터 전송을 위해서 Port 번호를 사용한다.  
<br>
⚒ Web에서는 신뢰성이 중요하기 떄문에 TCP 통신을 사용한다.  
...
![OSI 7 Layer]({{ site.baseurl }}/assets/img/network/Network-DataLink.png)
